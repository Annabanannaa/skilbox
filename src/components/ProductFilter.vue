      ...
      <fieldset class="form__block">
        ...
        <ul class="colors">
          <li class="colors__item">
            <label class="colors__label">
              <input class="colors__radio sr-only"
                     type="radio" name="color" value="#73B6EA" v-model="currentColor">
          ...
          <li class="colors__item">
            <label class="colors__label">
              <input class="colors__radio sr-only"
                     type="radio" name="color" value="#FFBE15" v-model="currentColor">
          ...
          <li class="colors__item">
            <label class="colors__label">
              <input class="colors__radio sr-only" type="radio"
                     v-model="currentColor" name="color" value="#939393">
          ...
          <li class="colors__item">
            <label class="colors__label">
              <input class="colors__radio sr-only"
                     v-model="currentColor" type="radio" name="color" value="#8BE000">
          ...
          <li class="colors__item">
            <label class="colors__label">
              <input class="colors__radio sr-only"
                     v-model="currentColor" type="radio" name="color" value="#FF6B00">
          ...
          <li class="colors__item">
            <label class="colors__label">
              <input class="colors__radio sr-only"
                     v-model="currentColor" type="radio" name="color" value="#80929d">
              <span class="colors__value" style="background-color: #80929d;">
                </span></label>
          </li>
          <li class="colors__item">
            <label class="colors__label">
...
export default {
  ...
  methods: {
    ...
    reset() {
      ...
      this.$emit('update:categoryId', '#73B6EA');
    },
    loadCategories() {
