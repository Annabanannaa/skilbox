<template>
  <main v-if="productLoading" class="content container">Загрузка товара....</main>
  <main v-else-if="!productData" class="content container">Не удалось загрузить товар...</main>
        ...
        <div class="item__form">
          <form class="form" action="#" @submit.prevent="addToCart" method="POST">
            ...
            <fieldset class="form__block">
              ...
              <ul class="colors">
                <li v-for="(item, index) in product.colors" :key="index"
                    class="colors__item">
      ...
      <div class="item__desc">
        ...
        <div class="item__content">
          ...
          <p>
            ...
            позволяет оптимизировать свои велотренировки, сделав их максимально
          ...
          <p>
            ...
            не входят в комплект поставки). Корпус велокомпьютера имеет степень защиты от
